...
<body class="bg-primary relative min-h-screen max-w-[100vw]">
   <div class="drawer drawer-open relative">
      <input id="my-drawer-2" type="checkbox" class="drawer-toggle" />
      <div class="drawer-content relative">
         @include('layouts.pet-owner.navbar')

         <div class="w-full pb-20 pt-10 flex">
            <div class="w-1/4 ms-6">
            ...
            <div class="w-3/4 bg-base-200 me-6 rounded-2xl max-w-[3/4] overflow-hidden">
               @yield('content')
            </div>
         </div>
      </div>
