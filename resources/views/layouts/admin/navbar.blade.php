	...
	<div class="px-3 py-3 lg:px-5 lg:pl-3">
		<div class="flex items-center justify-between">
			<div class="flex items-center justify-start rtl:justify-end">
				...
				<a href="/" class="flex items-center gap-1 ms-2  md:me-24">
					<img class="h-8" src="{{ asset('assets/temp_logo.png') }}" alt="logo">
					<span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">Pet-A</span>
				</a>
			</div>
