          ...
          <div class="flex-grow">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
              <label class="form-control w-full mb-3">
                ...
                <input type="date" name="birth_date" class="input input-bordered w-full form-validation" />
              </label>
              ...
              <label class="form-control w-full mb-3">
                ...
                <input type="number" name="length_of_service" class="input input-bordered w-full form-validation" />
              </label>
            </div>
