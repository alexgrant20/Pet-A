...
@section('content')
   <div class="card bg-base-100 shadow-xl w-full mb-5">
      <div class="card-body flex-row items-center justify-between">
         ...
         <div>
            <a href="{{ route('admin.master.medication-type.create') }}" class="btn btn-primary btn-padding">Add Medication
               Type <i class="fa fa-solid fa-plus"></i></a>
         </div>
      </div>
   </div>
...
@section('js-footer')
   <script>
      ...
      $(document).on('click', '#btn_delete_medication_type', function(e) {
         e.preventDefault();
         ...
         swal({
            title: "Are You Sure?",
            text: `You will delete medication type ${nama}`,
            icon: "warning",
            buttons: true,
            dangerMode: true,
         }).then((ok) => {
