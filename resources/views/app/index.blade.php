...
@section('content')
  <div>
    ...
    <section class="pt-20 hero min-h-screen bg-base-200" id="home">
      <div class="hero-content h-full flex-col lg:flex-row-reverse gap-20 justify-center xl:justify-end items-center relative">
        <img src="{{ asset('assets/hero-page-image.png') }}"
          class="w-screen h-screen absolute right-0 bottom-0 hidden xl:block" />
        <div data-aos="fade-right" data-aos-duration="1000" class="xl:w-1/2 w-full">
          <h1 class="text-4xl md:text-7xl text-gray-900 font-bold">Pet <span class="text-primary">personal</span> health care
          </h1>
    ...
    <section class="pt-20 hero min-h-screen bg-base-200" id="digitilize-data">
      <div class="hero-content h-full flex-row-reverse gap-20 justify-center xl:justify-end relative">
        <img src="{{ asset('assets/pet-ktp.png') }}"
          class="w-screen h-screen absolute right-0 bottom-0 hidden xl:block" />
        <div data-aos="fade-right" data-aos-duration="1000" class="w-full xl:w-1/2">
          <h3 class="text-4xl text-gray-900 font-bold">Track your pet <span class="text-primary">medical record</span>
            easiliy</h3>
          <p class="pt-9 text-xl text-gray-500">
    ...
    <section class="pt-20 hero min-h-screen bg-base-200" id="notification">
      <div class="hero-content h-full flex-col lg:flex-row-reverse gap-20 justify-center xl:justify-end relative">
        <img src="{{ asset('assets/high-five-pet.png') }}"
          class="w-screen h-screen absolute right-0 bottom-0 hidden xl:block" />
        <div data-aos="fade-right" data-aos-duration="1000" class="xl:w-1/2 w-full">
          <h2 class="text-4xl xl:text-6xl text-gray-900 font-bold">
          ...
          <div class="pt-4 flex flex-wrap gap-10">
