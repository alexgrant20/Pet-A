      ...
      <form action="{{ route('pet-owner.pet.store') }}" enctype="multipart/form-data" method="POST"
        ...
        <div class="grid grid-cols-2 gap-3 mb-5">
          ...
          <label class="form-control w-full">
            ...
            <select id="pet_type_id" name="pet_type_id" class="select select-2 select-bordered w-full form-control flex-row">
          ...
          <label class="form-control w-full">
            ...
            <select id="breed_id" name="breed_id" class="select select-bordered w-full form-control flex-row">
              <option value="" hidden></option>
            </select>
          </label>
