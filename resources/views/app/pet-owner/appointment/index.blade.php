...
@section('content')
   <div class="flex flex-col gap-8 min-h-[inherit] py-10 px-6">
      <div role="tablist" class="tabs tabs-boxed w-full">
         <input type="radio" name="my_tabs_1" role="tab" class="tab shadow bg-gray-300 text-gray-400" aria-label="Book Appointment" checked="checked" />
                              ...
                              <div class="flex flex-col flex-1">
                                 ...
                                 <div class="flex flex-row gap-1">
                                    @foreach ($veterinarian->petType->pluck('name') as $petType)
                                       <div class="badge badge-primary rounded-full font-semibold">{{ $petType }}
                                       </div>
                                    @endforeach
                                 </div>
                              </div>
                              ...
                              <div class="grid grid-cols-2 p-2">
                                 <div class="flex">
                                    <div class="flex flex-col flex-1 items-center">
                                       ...
                                       <span class="text-black/60 font-bold">{{ $veterinarian->length_of_service }}
                                          Tahun</span>
                                    </div>
                                 </div>
                                 <div class="flex flex-col flex-1 items-center">
